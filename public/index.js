...
function profileLink(type) {
  if (type == "vlogger") {
    ...
    document.getElementById("influencer-list").innerHTML =
      "Share your latest adventures with the world in one link.";
    document.getElementById("profile-li").innerHTML =
      "Profile-Vlogger platform for creators and influencers who want to simplify their online presence. Sign up for free and add all your social links, website link, and any other URL to get your own Profile link";
    document.getElementById("brand-collab").innerHTML =
      "Brand-Vlogger platform for creators and influencers who want to simplify their online presence. Sign up for free and add all your social links, website link, and any other URL to get your own Profile link";
    document.getElementById("brand-mobile").innerHTML =
      "Brand-mobile-vlogger platform for creators and influencers who want to simplify their online presence. Sign up for free and add all your social links, website link, and any other URL to get your own Profile link";
  }
  if (type == "gammer") {
